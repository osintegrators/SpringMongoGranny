...
public class TestAddressService {
	...
	public void testGetAllAddresses() {
		String[] expectedName = { "John Doe", "Sarah Palin", "John Edwards",
				"Joe Lieberman", "Jack Kemp", "Dan Quayle" };
		String[] expectedAddress = { "345 West Main St\nDurham, NC",
				"Overlooking Russia\nJuneau",
				"123 not at my house\nRaleigh, NC",
				"321 Not at my Party,\nHartford, CT",
		...
		String[] expectedPhone = { "+1.919.321.0119", "999-9999", "199-9999",
				"991-9999", "999-9998", "113-1548" };
		String[] expectedEmail = { "spam@osintegrators.com", "sarah@gop.org",
				"john@nowhere.com", "joe@nowhere.com", "jack@gop.org",
				"dan@gop.org" };

		for (int i = 1; i < expectedName.length; i++) { // ignore john doe for
														// create
			Address address = createAddressObject(expectedName[i],
					expectedAddress[i], expectedPhone[i], expectedEmail[i]);
			addressService.createAddress(address);
		}
		...
		assertEquals(
				"there should be equal number of addresses as there are expectedName array entries",
